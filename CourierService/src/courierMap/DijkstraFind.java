...
public class DijkstraFind {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            ArrayList<Integer> path = finder.shortestPath(4, 26);
            System.out.print("Test 1/Yellow: 4 -> 17: " + finder.shortestPath(4, 26) + "\n");
            System.out.print("Test 1/Yellow: 4 -> 26:Weight " + graph.findWeight(4, 26, path) + "\n");
            path = finder.shortestPath(4, 19);
            System.out.print("Test 2/Blue: 4 -> 19: " + finder.shortestPath(4, 19) + "\n");
            System.out.print("Test 1/Yellow: 4 -> 26:Weight " + graph.findWeight(4, 19, path) + "\n");
            path = finder.shortestPath(4, 28);
            System.out.print("Test 3/Green: 3 -> 28: " + finder.shortestPath(3, 28) + "\n");
            System.out.print("Test 1/Yellow: 4 -> 26:Weight " + graph.findWeight(3, 28, path) + "\n");
